...
class PositionFrame(ctk.CTkFrame):
    def __init__(self,parent,pos_vars):
        ...
        SliderPanel(self,'Zoom',pos_vars['zoom'],0,2)
...
class EffectFrame(ctk.CTkFrame):
    def __init__(self,parent,effect_vars):
        ...
        RevertButton(self,(effect_vars['blur'],BLUR_DEFAULT),(effect_vars['contrast'],CONTRAST_DEFAULT),(effect_vars['effect'],EFFECT_OPTIONS[0]))
